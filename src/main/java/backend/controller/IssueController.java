...
public class IssueController {
	...
	public ResponseEntity<PagedResources<Resource<Issue>>> getIssues(
			...
			Pageable pageable, PagedResourcesAssembler<Issue> assembler)
		...
		return new ResponseEntity<PagedResources<Resource<Issue>>>(assembler.toResource(issues), HttpStatus.OK);
	}
}
